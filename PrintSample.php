...
$client_id = '85109d56a63f419b87a25d4dc2525388';
$secret = 'o4KgVHuguJfmLD82R0RKgOFJD3dQc6j11QSLFODTHdCCh25ZyCCiHrcQ8pkg4oZ8';
$device = 'idw9080tn66pj5@print.epsonconnect.com';
...
if ($select == "1") {
    $local_file_path = './img/coupon_1000.pdf';
} else if ($select == "2") {
    $local_file_path = './img/coupon_2000.pdf';
} else if ($select == "3") {
    $local_file_path = './img/coupon_3000.pdf';
} else if ($select == "4") {
    $local_file_path = './img/coupon_4000.pdf';
} else {
    $local_file_path = './img/coupon_4000.pdf';
    $num01 = (int) $select;
    $secret = $num01 - $print_page;
    $secret = (string) $secret;
}

//$local_file_path = './img/coupon_1000.pdf';
//$local_file_path = '../img/' . $select . '.pdf';
